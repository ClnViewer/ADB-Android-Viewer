...
#define __LUA_FUNC_CODE_BODY(funname, args_in, args_out, helpstr, ext_fun)                                      \
...
#define __LUA_FUNC_EXT_TEMPLATE(funname, body)                                                                  \
...
#define __LUA_FUNC_ARGS_INPUT_NUMBER_4_OR_NUMBER_1_TABLE()                                                      \
    ((lua_istable(m_lua, -1)) ? 2 : ((lua_isnumber(m_lua, -1)) ? 4 : 0))
#define __LUA_FUNC_ARGS_INPUT_NUMBER_4_OR_TABLE()                                                               \
    ((lua_istable(m_lua, -1)) ? 1 : ((lua_isnumber(m_lua, -1)) ? 4 : 0))
#define __LUA_FUNC_ARGS_INPUT_NUMBER_5_OR_NUMBER_2_TABLE()                                                      \
    ((lua_istable(m_lua, -1)) ? 3 : ((lua_isnumber(m_lua, -1)) ? 5 : 0))

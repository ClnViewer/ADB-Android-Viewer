...
#   if defined(_BUILD_LUA_EDITOR)
    static inline const char g_lint_str_51[] = " -- Debug window output disabled, ";
    static inline const char g_lint_str_52[] = " -- Debug window output enabled, ";
#   else
    static inline const char g_lint_str_51[] = " -- Debug output trace disabled, ";
    static inline const char g_lint_str_52[] = " -- Debug output trace enabled, using DebugView for show, ";
#   endif

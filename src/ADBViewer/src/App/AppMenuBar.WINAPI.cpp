...
bool AppMenuBar::savefile(std::string & fname)
{
    OPENFILENAMEA sfn{};
    std::stringstream ss;
...
bool AppMenuBar::openfile(std::string & fname)
{
    OPENFILENAMEA sfn{};
    fname.resize(512);
...
bool AppMenuBar::savefile(std::string&) { return false; }
bool AppMenuBar::openfile(std::string&) { return false; }
